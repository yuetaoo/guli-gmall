...
public class UserAddressController {
    ...
    public ResponseVo<List<UserAddressEntity>> queryAddressByUserId(@PathVariable("userId")Long userId){
        List<UserAddressEntity> userAddressList = userAddressService.list(new QueryWrapper<UserAddressEntity>().eq("user_id", userId));
        return ResponseVo.ok(userAddressList);
    }
