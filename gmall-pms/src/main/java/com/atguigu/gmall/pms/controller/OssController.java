...
public class OssController {
    ...
    String accessId = "LTAI4G4yhQboDsGbLRgagX8U"; // 请填写您的AccessKeyId。
    String accessKey = "ogOWXZZPTiR98YsdVqZoCHmqTBLjbk"; // 请填写您的AccessKeySecret。
    String endpoint = "oss-cn-beijing.aliyuncs.com"; // 请填写您的 endpoint。
    String bucket = "guigu-gmall"; // 请填写您的 bucketname 。
